...
public class ChildValues extends GenericValues {
    ...
    public ChildValues() {
        ...
        this.alliesShipListBorder = new LineBorder(Color.GREEN, 1, false);
        ...
        this.alliesBanner = new ImageIcon("graphics/childMyListMotherShip.png");
        ...
        this.alliesShipsIcons.add(new ImageIcon("graphics/childMyListShip.png"));
